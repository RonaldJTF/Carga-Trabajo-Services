...
public class MergeCommand extends AbstractCommand {
    ...
    public Size applyAt(CellRef cellRef, Context context) {
        ...
        //return new Size(cols, rows); //Original
        return new Size(cols, this.area.getSize().getHeight()); //New: Solo afecta las colunmas, es decir, si se ocupa una, todo se desplaza
    }
