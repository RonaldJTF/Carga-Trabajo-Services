...
@AllArgsConstructor
@Entity
@Table(name = "ACTIVIDADGESTIONOPERATIVA", schema = "FORTALECIMIENTO")
public class ActividadGestionOperativaEntity implements Serializable {
    @Id
    @Column(name = "acgo_id", nullable = false)
    ...
    @Column(name = "acgo_fechacambio")
    @Temporal(TemporalType.TIMESTAMP)
    private Date fechaCambio;

    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY)
    @Column(name = "acgo_registradopor", nullable =  false, length = 250)
